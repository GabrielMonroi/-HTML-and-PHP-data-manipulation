...
<html lang="pt-br">
	...
	<div class="container theme-showcase" role="main">
		...
		<div class="page-header">
		<form action="Salva_User.php" method="post">
            <!-- Jogamos os valores a serem editados dentro dos inputs no campo value -->
			<label>Id:</label>
            <input type="text" name="id" value="<?php echo $id; ?>" style="width:22px;">
            <label>Nome:</label>
			<input type="text" name="nome" value="<?php echo $nome; ?>">
			
            <label>Email:</label>
			<input type="text" name="usuario" value="<?php echo $usuario; ?>" style="width:250px;">
